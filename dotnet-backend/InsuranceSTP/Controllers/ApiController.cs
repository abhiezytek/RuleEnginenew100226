...
public class ApiController : ControllerBase
{
    ...
    public async Task<IActionResult> SeedData()
    {
        ...
        {
            CreateRule("Missing Income Validation", "validation", new { logical_operator = "OR", conditions = new[] { new { field = "applicant_income", @operator = "is_empty", value = (object?)null }, new { field = "applicant_income", @operator = "less_than_or_equal", value = 0 } }, is_negated = false }, new { decision = "FAIL", reason_code = "VAL001", reason_message = "Applicant income is missing or invalid", is_hard_stop = true }, 10),
            CreateRule("Missing Premium Validation", "validation", new { logical_operator = "OR", conditions = new[] { new { field = "premium", @operator = "is_empty", value = (object?)null }, new { field = "premium", @operator = "less_than_or_equal", value = 0 } }, is_negated = false }, new { decision = "FAIL", reason_code = "VAL002", reason_message = "Premium amount is missing or invalid", is_hard_stop = true }, 10),
            CreateRule("Age Eligibility Check", "validation", new { logical_operator = "OR", conditions = new[] { new { field = "applicant_age", @operator = "less_than", value = 18 }, new { field = "applicant_age", @operator = "greater_than", value = 70 } }, is_negated = false }, new { decision = "FAIL", reason_code = "VAL003", reason_message = "Applicant age must be between 18 and 70 years", is_hard_stop = true }, 10),
            CreateRule("High Sum Assured Check", "stp_decision", new { logical_operator = "AND", conditions = new[] { new { field = "sum_assured", @operator = "greater_than", value = 10000000 } }, is_negated = false }, new { decision = "FAIL", reason_code = "STP001", reason_message = "Sum assured exceeds STP limit - Medical required", is_hard_stop = false }, 20),
            CreateRule("Smoker High Risk", "stp_decision", new { logical_operator = "AND", conditions = new[] { new { field = "is_smoker", @operator = "equals", value = true }, new { field = "sum_assured", @operator = "greater_than", value = 5000000 } }, is_negated = false }, new { decision = "FAIL", reason_code = "STP002", reason_message = "Smoker with high coverage - Additional underwriting required", is_hard_stop = false }, 25),
            CreateRule("Medical History Check", "stp_decision", new { logical_operator = "AND", conditions = new[] { new { field = "has_medical_history", @operator = "equals", value = true } }, is_negated = false }, new { decision = "FAIL", reason_code = "STP003", reason_message = "Medical history present - Underwriter review required", is_hard_stop = false }, 30),
            CreateRule("Low Risk Direct Accept", "case_type", new { logical_operator = "AND", conditions = new[] { new { field = "applicant_age", @operator = "between", value = 25, value2 = 45 }, new { field = "is_smoker", @operator = "equals", value = false }, new { field = "has_medical_history", @operator = "equals", value = false }, new { field = "sum_assured", @operator = "less_than_or_equal", value = 5000000 } }, is_negated = false }, new { case_type = 1, reason_code = "CT001", reason_message = "Low risk profile - Direct Accept" }, 50),
            CreateRule("GCRP Referral", "case_type", new { logical_operator = "OR", conditions = new[] { new { field = "occupation_risk", @operator = "equals", value = "high" }, new { field = "applicant_age", @operator = "greater_than", value = 55 } }, is_negated = false }, new { case_type = 3, reason_code = "CT002", reason_message = "Referred to GCRP for additional review" }, 60),
            CreateRule("Age Score - Young Adult Bonus", "scorecard", new { logical_operator = "AND", conditions = new[] { new { field = "applicant_age", @operator = "between", value = 25, value2 = 35 } }, is_negated = false }, new { score_impact = 15, reason_code = "SC001", reason_message = "Age bonus: 25-35 years" }, 100),
            CreateRule("Non-Smoker Bonus", "scorecard", new { logical_operator = "AND", conditions = new[] { new { field = "is_smoker", @operator = "equals", value = false } }, is_negated = false }, new { score_impact = 20, reason_code = "SC002", reason_message = "Non-smoker bonus" }, 100)
        };
    ...
    // Helper methods
    private Rule CreateRule(string name, string category, object conditionGroup, object action, int priority)
    {
        return new Rule
        {
            Name = name,
